...
export const Heading: FC<{level: 1 | 2 | 3 | 4; size?: 'sm' | 'md' | 'lg' | 'xl'; children: ReactNode; className?: string}> = ({
  ...
  const sizes = {
    sm: 'text-lg lg:text-xl drop-shadow-sm',
    md: 'text-xl lg:text-2xl drop-shadow',
    lg: 'text-2xl lg:text-3xl drop-shadow-md',
    xl: 'text-3xl sm:text-4xl lg:text-5xl drop-shadow-lg'
  }
